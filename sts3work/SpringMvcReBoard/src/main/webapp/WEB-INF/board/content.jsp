		...
		<table class="table table-bordered" style="width: 600px;">
			...
			<tr>
				<td>
					...
					<c:if test="${dto.photo!='no' }">
						...
						<a href="../photo/${pi }">
							<img alt="" src="../photo/${pi}" style="max-width: 150px;">
						</a>
						</c:forTokens>
					</c:if>
				</td>				
			...
			<tr>
				<td>
					...
					<span class="adel glyphicon glyphicon-trash" style="cursor: pointer;" idx=${a.idx} ></span>
					<br>
					</c:forEach>
					...
					<script type="text/javascript">
						...
						$("span.adel").click(function () {
							...
							//alert(pass);
							if (pass==null)//prompt취소 눌렀을시 함수종료
								return; 
					...
					<form action="ainsert" method="post" class="form-inline">
						...
						<div>
							...
							<br><br>
							<input type="text" name="content" class="form-control" style="width: 500px;" required="required" placeholder="댓글 내용을 입력해주세요">
			...
			<tr>
				<td align="right">
					...
					<button class="btn btn-info btn-sm"	onclick="location.href='writeform?num=${dto.num}&regroup=${dto.regroup }&restep=${dto.restep }&relevel=${dto.relevel }&currentPage=${currentPage}'">답글</button>

...
public class ShopDao {
	...
	public void insertShop(ShopDto dto) {
		...
		String sql="insert into shop2 values (null,?,?,?,?,?)";
	...
	public List<ShopDto> getAllSangpums() {
	   ...
	   String sql="select * from shop2 order by shopnum desc";
	...
	public ShopDto getData(String shopnum) {
		...
		String sql="select * from shop2 where shopnum=?";
	...
	//조인(여러가지 2,3개 클래스에서 하나씩 뽑는거)...장바구니 출력
	//idx, 상품명, 상품번호, 사진, 가격, 수량, 카트에 담은 날짜(id)
	public List<HashMap<String, String>> getCartList(String id) //join 필요할때 jashmap 주로 담는다.
	   {

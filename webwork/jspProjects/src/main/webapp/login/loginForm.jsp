		...
		<table class="table table-bordered" style="width:250px;"> 
			...
			<tr height="30">
				<td colspan="2" style="padding-left:10px;">
					...
					<%
						...
						<%}else{//체크상태면? %>
						<input type="checkbox" name="savechk" checked="checked">아이디 저장			
						<%}
					%>
			...
			<tr height="30">
				...
				<%
					if(saveok==null){
						%>
						<input type="text" size="10" name="id" autofocus="autofocus" value="">
					<%}else{//체크상태면?
						%>
						<input type="text" size="10" name="id" autofocus="autofocus" value="<%=id%>">	
					<%}
				%>
				</td>
			</tr>
			...
			<tr height="30">
				<th width="80">비밀번호</th>
				<td>
					<input type="password" size="10" name="pass" required="required" class="form=control">
				</td>
			</tr>

...
List<NewmemDto> list=dao.getAllDatas();
%>
...
<div class="memberlist">
  ...
  <button type="button" class="btn btn-info log" onclick="location.href='../newlog/logoutaction.jsp'">로그아웃</button>
  <br><br>
    	  ...
    	  <tr align="center">
    	    ...
    	    <td><%=dto.getHp() %></td>
    	     ...
    	     if(loginok!=null && dto.getMid().equals(mid)){
    	       ...
    	       onclick="location.href='../A_newmem/updateform.jsp?num=<%=dto.getNum()%>'">수정</button>
 ...
 <!-- Modal -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <button type="button" class="btn btn-danger" id="btnmdel">탈퇴확인</button>
        </div>
  ...
  <script type="text/javascript">
  	...
  	$("#btnmdel").click(function () {
		...
		//이동
		location.href="../A_newmem/deletemember.jsp?num="+num;
	});
  </script>

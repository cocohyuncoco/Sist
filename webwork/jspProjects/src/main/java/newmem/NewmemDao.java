...
public class NewmemDao {
   ...
   //전체출력
   public List<NewmemDto> getAllDatas()
   {
   ...
   //로그인에 필요(1.아이디,비번이 모두 맞다 2.아이디는 맞고 비번이 틀림 3.아이디가 없음)
   ...
   //수정
   public void updateNewmem(NewmemDto dto)
   {
      Connection conn=db.getConnection();
      PreparedStatement pstmt=null;
   ...
   //삭제
   public void deleteNewmem(String num)
   {
      Connection conn=db.getConnection();
      PreparedStatement pstmt=null;
      
      String sql="delete from newmem where num=?";
